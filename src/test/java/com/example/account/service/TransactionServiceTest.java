...
class TransactionServiceTest {
    ...
    void useBalanceTransaction_UserNotFound() {
        //given
        given(accountUserRepository.findById(anyLong()))
    ...
    void useBalanceTransaction_AccountNotFound() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi")
                .build();
    ...
    void useBalanceTransactionFailed_userUnMatch() {
        //given
    ...
    void useBalanceTransactionFailed_alreadyUnregistered() {
        //given
        AccountUser pobi = AccountUser.builder()
                .name("Pobi").build();
        pobi.setId(12L);
